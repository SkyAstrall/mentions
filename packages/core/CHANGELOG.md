...
- 77db4d4: Version-aligned with the v0.4.0 monorepo release line. No public API or behavior changes in `core`. See [`packages/svelte/CHANGELOG.md`](../svelte/CHANGELOG.md) for the Svelte 5 adapter that shipped under this version.
